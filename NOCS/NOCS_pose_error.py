...
def compute_error_degree_cm_transform(RT1, RT2, class_name, handle_visibility = 0, uniformly_scaling=True):
    ...
    T1, _, R1 = decompose_transform_matrix(RT1, uniformly_scaling)
    T2, _, R2 = decompose_transform_matrix(RT2, uniformly_scaling)
