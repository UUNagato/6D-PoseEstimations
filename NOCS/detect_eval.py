...
parser.add_argument('--ckpt_path', type=str, default='logs/ckpt/nocs_rcnn_res50_bin32.h5')
...
if __name__ == '__main__':
    ...
    if mode == 'detect':
        ...
        log_dir = '/home/v-xli2/NOCS_CVPR2019/output/real_test_20201109T1105/'
        ...
        for pkl_path in result_pkl_list:
            ...
            if type(result) is list:
                ...
                assert False
        if args.decompose:
            print ('decompose computation is used')
            aps = utils.compute_degree_cm_mAP_decompose(final_results, synset_names, log_dir,
                                                                    degree_thresholds = range(0, 61, 1),#[5, 10, 15],#range(0, 61, 1), 
                                                                    shift_thresholds= np.linspace(0, 1, 31) * 15, #[5, 10, 15], #np.linspace(0, 1, 31)*15, 
